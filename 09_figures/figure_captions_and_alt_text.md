...
Status: draft, needs final visual polish. Captions should be inserted during manuscript assembly, not inside the SVG files.
...
- Status: draft, needs final visual polish.
...
- Proposed manuscript caption: Cross-block evidence flow for the review. Resource and language conditions shape model choice, adaptation, and supervision, while evaluation and robustness checks feed back into data design, adaptation comparison, and the future research agenda.
