...
This file maps Markdown draft sources to LaTeX manuscript sections.

| Markdown draft source | LaTeX section |
|---|---|
| `07_draft_sections/00_abstract.md` | `\abstract{...}` |
| `07_draft_sections/01_introduction.md` | `\section{Introduction}` |
| `07_draft_sections/02_evolution_of_asr.md` | `\section{Evolution of ASR}` |
| `07_draft_sections/03_low_resource_challenges.md` | `\section{Core Challenges in Low-Resource ASR}` |
| `07_draft_sections/04_end_to_end_asr.md` | `\section{End-to-End ASR}` |
...
| `07_draft_sections/13_future_directions.md` | `\section{Future Directions}` |
| `07_draft_sections/14_conclusion.md` | `\section{Conclusion}` |

## Use

When a Markdown draft section is mature, transfer polished prose into `12_manuscript/latex/main.tex` and update this mapping if section titles change.
