...
% AIR author guidelines request the Springer Nature template and show
% author-year references. The iicol option previews the double-column layout
% commonly seen in published Springer articles.
